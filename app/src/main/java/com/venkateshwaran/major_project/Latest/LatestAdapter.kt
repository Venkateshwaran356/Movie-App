...
import com.venkateshwaran.major_project.databinding.LatestLayoutBinding
...
class LatestAdapter : RecyclerView.Adapter<LatestAdapter.ViewHolder>() {
    ...
    class ViewHolder(val binding: LatestLayoutBinding) : RecyclerView.ViewHolder(binding.root) {}

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            LatestLayoutBinding.inflate(
                LayoutInflater.from(
                    parent.context
                )
            )
